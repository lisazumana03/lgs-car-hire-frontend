          ...
          <>
            ...
            <main className="main-content">
              <Routes>
                ...
                <Route path="/booking-details" element={<BookingDetails user={currentUser} />} />
                <Route path="/booking-details/:id" element={<BookingDetails user={currentUser}  />} />
                ...
                {/* Invoice routes */}
                <Route path="/invoices" element={<InvoiceList user={currentUser} />} />
                <Route path="/invoices/:id" element={<InvoiceView user={currentUser} />} />
                ...
                {isAdmin && (
                    <li>
                        <Link
                            ...
                            className={`sidebar-link ${location.pathname === '/payment-management' ? 'active' : ''}`}
                        >
                            <span className="icon">💳</span>
